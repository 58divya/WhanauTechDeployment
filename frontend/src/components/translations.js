const translations = {
	en: {
		...
		contact: {
			...
			form: {
				...
				messageMinWordsError: "Please write a message with at least 10 words.",
	...
	mi: {
		...
		contact: {
			...
			form: {
				nameLabel: "Ingoa",
				namePlaceholder: "Tuhia tō ingoa",
				emailLabel: "Īmēra",
				emailPlaceholder: "Tuhia tō īmēra",
				messageLabel: "Karere",
				messagePlaceholder: "Tuhia tō karere",
				messageMinWordsError:
					"Tēnā koa, tuhia tētahi karere neke atu i te 10 kupu.",
				successMessage: "Kua tukuna tō karere!",
				errorMessage: "I puta he hapa. Tēnā whakamātau anō ā muri ake.",
				connectionError: "Kāore i taea te hono atu ki te tūmau:",
				sendingButton: "Kei te tuku...",
				sendButton: "Tukua",
			},
		},
		chatbot: {
